// Things to FIX : Sort is not 100% ==> UPPER and lower case traeted differently
// How do you search just the root directory of a drive? ==> "c:\*" does not work LOWERCASE ! ==> "C:\*" works

// Search results are NOT sorted ... should we ?
// Search queries are executed INCLUSIVE (lower & UPPERR) cases are found
...
public:
	...
	BOOL OnInitDialog(CWindow /*wndFocus*/, LPARAM /*lInitParam*/)
	{
		...
		{ int const icol = COLUMN_INDEX_NAME              ; LVCOLUMN column = { LVCF_FMT | LVCF_WIDTH | LVCF_TEXT, LVCFMT_LEFT   , 250, this->LoadString(IDS_COLUMN_NAME_HEADER                    )}; this->lvFiles.InsertColumn(icol, &column); }
		{ int const icol = COLUMN_INDEX_PATH              ; LVCOLUMN column = { LVCF_FMT | LVCF_WIDTH | LVCF_TEXT, LVCFMT_LEFT   , 280, this->LoadString(IDS_COLUMN_PATH_HEADER                    )}; this->lvFiles.InsertColumn(icol, &column); }
		{ int const icol = COLUMN_INDEX_TYPE              ; LVCOLUMN column = { LVCF_FMT | LVCF_WIDTH | LVCF_TEXT, LVCFMT_LEFT   , 120, this->LoadString(IDS_COLUMN_TYPE_HEADER                    )}; this->lvFiles.InsertColumn(icol, &column); }
		{ int const icol = COLUMN_INDEX_SIZE              ; LVCOLUMN column = { LVCF_FMT | LVCF_WIDTH | LVCF_TEXT, LVCFMT_RIGHT  ,  80, this->LoadString(IDS_COLUMN_SIZE_HEADER                    )}; this->lvFiles.InsertColumn(icol, &column); }
		{ int const icol = COLUMN_INDEX_SIZE_ON_DISK      ; LVCOLUMN column = { LVCF_FMT | LVCF_WIDTH | LVCF_TEXT, LVCFMT_RIGHT  ,  80, this->LoadString(IDS_COLUMN_SIZE_ON_DISK_HEADER            )}; this->lvFiles.InsertColumn(icol, &column); }
		{ int const icol = COLUMN_INDEX_CREATION_TIME     ; LVCOLUMN column = { LVCF_FMT | LVCF_WIDTH | LVCF_TEXT, LVCFMT_CENTER , 140, this->LoadString(IDS_COLUMN_CREATION_TIME_HEADER           )}; this->lvFiles.InsertColumn(icol, &column); }
		{ int const icol = COLUMN_INDEX_MODIFICATION_TIME ; LVCOLUMN column = { LVCF_FMT | LVCF_WIDTH | LVCF_TEXT, LVCFMT_CENTER , 140, this->LoadString(IDS_COLUMN_WRITE_TIME_HEADER              )}; this->lvFiles.InsertColumn(icol, &column); }
		{ int const icol = COLUMN_INDEX_ACCESS_TIME       ; LVCOLUMN column = { LVCF_FMT | LVCF_WIDTH | LVCF_TEXT, LVCFMT_CENTER , 140, this->LoadString(IDS_COLUMN_ACCESS_TIME_HEADER             )}; this->lvFiles.InsertColumn(icol, &column); }
		{ int const icol = COLUMN_INDEX_DESCENDENTS       ; LVCOLUMN column = { LVCF_FMT | LVCF_WIDTH | LVCF_TEXT, LVCFMT_RIGHT  ,  80, this->LoadString(IDS_COLUMN_DESCENDENTS_HEADER             )}; this->lvFiles.InsertColumn(icol, &column); }
		{ int const icol = COLUMN_INDEX_is_readonly       ; LVCOLUMN column = { LVCF_FMT | LVCF_WIDTH | LVCF_TEXT, LVCFMT_CENTER ,  25, this->LoadString(IDS_COLUMN_INDEX_IS_READONLY_HEADER       )}; this->lvFiles.InsertColumn(icol, &column); }
		{ int const icol = COLUMN_INDEX_is_archive        ; LVCOLUMN column = { LVCF_FMT | LVCF_WIDTH | LVCF_TEXT, LVCFMT_CENTER ,  25, this->LoadString(IDS_COLUMN_INDEX_IS_ARCHIVE_HEADER        )}; this->lvFiles.InsertColumn(icol, &column); }
		{ int const icol = COLUMN_INDEX_is_system         ; LVCOLUMN column = { LVCF_FMT | LVCF_WIDTH | LVCF_TEXT, LVCFMT_CENTER ,  25, this->LoadString(IDS_COLUMN_INDEX_IS_SYSTEM_HEADER         )}; this->lvFiles.InsertColumn(icol, &column); }
		{ int const icol = COLUMN_INDEX_is_hidden         ; LVCOLUMN column = { LVCF_FMT | LVCF_WIDTH | LVCF_TEXT, LVCFMT_CENTER ,  25, this->LoadString(IDS_COLUMN_INDEX_IS_HIDDEN_HEADER         )}; this->lvFiles.InsertColumn(icol, &column); }
		{ int const icol = COLUMN_INDEX_is_offline        ; LVCOLUMN column = { LVCF_FMT | LVCF_WIDTH | LVCF_TEXT, LVCFMT_CENTER ,  25, this->LoadString(IDS_COLUMN_INDEX_IS_OFFLINE_HEADER        )}; this->lvFiles.InsertColumn(icol, &column); }
		{ int const icol = COLUMN_INDEX_is_notcontentidx  ; LVCOLUMN column = { LVCF_FMT | LVCF_WIDTH | LVCF_TEXT, LVCFMT_CENTER ,  25, this->LoadString(IDS_COLUMN_INDEX_IS_NOTCONTENTIDX_HEADER  )}; this->lvFiles.InsertColumn(icol, &column); }
		{ int const icol = COLUMN_INDEX_is_noscrubdata    ; LVCOLUMN column = { LVCF_FMT | LVCF_WIDTH | LVCF_TEXT, LVCFMT_CENTER ,  25, this->LoadString(IDS_COLUMN_INDEX_IS_NOSCRUBDATA_HEADER    )}; this->lvFiles.InsertColumn(icol, &column); }
		{ int const icol = COLUMN_INDEX_is_integretystream; LVCOLUMN column = { LVCF_FMT | LVCF_WIDTH | LVCF_TEXT, LVCFMT_CENTER ,  25, this->LoadString(IDS_COLUMN_INDEX_IS_INTEGRETYSTREAM_HEADER)}; this->lvFiles.InsertColumn(icol, &column); }
		{ int const icol = COLUMN_INDEX_is_pinned         ; LVCOLUMN column = { LVCF_FMT | LVCF_WIDTH | LVCF_TEXT, LVCFMT_CENTER ,  25, this->LoadString(IDS_COLUMN_INDEX_IS_PINNED_HEADER         )}; this->lvFiles.InsertColumn(icol, &column); }
		{ int const icol = COLUMN_INDEX_is_unpinned       ; LVCOLUMN column = { LVCF_FMT | LVCF_WIDTH | LVCF_TEXT, LVCFMT_CENTER ,  25, this->LoadString(IDS_COLUMN_INDEX_IS_UNPINNED_HEADER       )}; this->lvFiles.InsertColumn(icol, &column); }
		{ int const icol = COLUMN_INDEX_is_directory      ; LVCOLUMN column = { LVCF_FMT | LVCF_WIDTH | LVCF_TEXT, LVCFMT_CENTER ,  30, this->LoadString(IDS_COLUMN_INDEX_IS_DIRECTORY_HEADER      )}; this->lvFiles.InsertColumn(icol, &column); }
		{ int const icol = COLUMN_INDEX_is_compressed     ; LVCOLUMN column = { LVCF_FMT | LVCF_WIDTH | LVCF_TEXT, LVCFMT_CENTER ,  80, this->LoadString(IDS_COLUMN_INDEX_IS_COMPRESSED_HEADER     )}; this->lvFiles.InsertColumn(icol, &column); }
		{ int const icol = COLUMN_INDEX_is_encrypted      ; LVCOLUMN column = { LVCF_FMT | LVCF_WIDTH | LVCF_TEXT, LVCFMT_CENTER ,  70, this->LoadString(IDS_COLUMN_INDEX_IS_ENCRYPTED_HEADER      )}; this->lvFiles.InsertColumn(icol, &column); }
		{ int const icol = COLUMN_INDEX_is_sparsefile     ; LVCOLUMN column = { LVCF_FMT | LVCF_WIDTH | LVCF_TEXT, LVCFMT_CENTER ,  50, this->LoadString(IDS_COLUMN_INDEX_IS_SPARSEFILE_HEADER     )}; this->lvFiles.InsertColumn(icol, &column); }
		{ int const icol = COLUMN_INDEX_is_reparsepoint   ; LVCOLUMN column = { LVCF_FMT | LVCF_WIDTH | LVCF_TEXT, LVCFMT_CENTER ,  60, this->LoadString(IDS_COLUMN_INDEX_IS_REPARSEPOINT_HEADER   )}; this->lvFiles.InsertColumn(icol, &column); }
		{ int const icol = COLUMN_INDEX_ATTRIBUTE		  ; LVCOLUMN column = { LVCF_FMT | LVCF_WIDTH | LVCF_TEXT, LVCFMT_CENTER ,  60, this->LoadString(IDS_COLUMN_INDEX_IS_ATTRIBUTE_HEADER      )}; this->lvFiles.InsertColumn(icol, &column); }
...
#undef  X
	...
	void GetSubItemText(size_t const j, int const subitem, bool const for_ui, std::tvstring &text, bool const lock_index = true) const
	{
		...
		switch (subitem)
		{
			...
			case COLUMN_INDEX_ATTRIBUTE			: uvalue = i->get_stdinfo(frs).attributes();  text += nformat(uvalue); break;
	...
	LRESULT OnFilesListCustomDraw(LPNMHDR pnmh)
	{
		//deletedColor(RGB(0xC0, 0xC0, 0xC0)), encryptedColor(RGB(0, 0xFF, 0)), compressedColor(RGB(0, 0, 0xFF)), directoryColor(RGB(0xFF, 0x99, 0x33)), hiddenColor(RGB(0xFF, 0x99, 0x99)), systemColor(RGB(0xFF, 0, 0))
		LRESULT result;
		COLORREF const deletedColor = RGB(0xC0, 0xC0, 0xC0);
		COLORREF const encryptedColor = RGB(0, 0xFF, 0);
		COLORREF const compressedColor = RGB(0, 0, 0xFF);
		COLORREF const directoryColor = RGB(0xFF, 0x99, 0x33);
		COLORREF const hiddenColor = RGB(0xFF, 0x99, 0x99);
		COLORREF const systemColor = RGB(0xFF, 0, 0);
		COLORREF const sparseColor = RGB(GetRValue(compressedColor), (GetGValue(compressedColor) + GetBValue(compressedColor)) / 2, (GetGValue(compressedColor) + GetBValue(compressedColor)) / 2);
...
int _tmain(int argc, TCHAR *argv[])
{
	...
	{
		HANDLE outHandle;
		outHandle = CreateFileW((LPCTSTR) L"Hallotest.txt", //argv[1],     // name of the write //(L"Hallotest2.txt")
		...
		try
		{
			...
			while (!pending.empty())
			{
				...
				if (i) // results of scan ... one at a time
				{
					...
					public:
						...
						void operator()(std::tvstring &line_buffer, bool const force = false, HANDLE* outHandle = nullptr, std::ofstream* outputfile = nullptr)
						{
					...
					/* TODO: Factor out common code from here and GUI-based version! */
					{
						...
						if (match)
						{
							line_buffer.push_back(_T('\"')); line_buffer += root_path; 	i->get_path(key, line_buffer, false); line_buffer.push_back(_T('\"'));
							
							if (header)
							{
								line_buffer.begin();
								line_buffer.insert(0, _TEXT("\"Path\", \"Name\", \"Size\", \"Size on Disk\", \"Created\", \"Last Written\", \"Last Accessed\", \"Descendents\", \"Read-only\", \"Archive\", \"System\", \"Hidden\", \"Offline\", \"Not content indexed file\", \"No scrub file\", \"Integrity\", \"Pinned\", \"Unpinned\", \"Directory Flag\", \"Compressed\", \"Encrypted\", \"Sparse\", \"Attributes \"\n"));
								header = false;
							}
							...
							if (output_everything)
							{
								...
								line_buffer.push_back(separator); line_buffer.push_back(_T('\"')); i->get_path(key, line_buffer, true); line_buffer.push_back(_T('\"'));
								
								line_buffer.push_back(separator); line_buffer += nformat(sizeinfo.length);
								line_buffer.push_back(separator); line_buffer += nformat(sizeinfo.allocated);

								/*  File attribute abbreviations: https://en.wikipedia.org/wiki/File_attribute#Types */
								line_buffer.push_back(separator); CMainDlg::SystemTimeToStringImpl(stdinfo.created, line_buffer, true, true, time_zone_bias, lcid);
								line_buffer.push_back(separator); CMainDlg::SystemTimeToStringImpl(stdinfo.written, line_buffer, true, true, time_zone_bias, lcid);
								line_buffer.push_back(separator); CMainDlg::SystemTimeToStringImpl(stdinfo.accessed, line_buffer, true, true, time_zone_bias, lcid);
								line_buffer.push_back(separator); line_buffer += nformat(static_cast<unsigned int>(sizeinfo.treesize));

								line_buffer.push_back(separator); if (stdinfo.is_readonly        > 0) line_buffer += nformat(1);
								line_buffer.push_back(separator); if (stdinfo.is_archive         > 0) line_buffer += nformat(1);
								line_buffer.push_back(separator); if (stdinfo.is_system          > 0) line_buffer += nformat(1);
								line_buffer.push_back(separator); if (stdinfo.is_hidden          > 0) line_buffer += nformat(1);
								line_buffer.push_back(separator); if (stdinfo.is_offline         > 0) line_buffer += nformat(1);
								line_buffer.push_back(separator); if (stdinfo.is_notcontentidx   > 0) line_buffer += nformat(1);
								line_buffer.push_back(separator); if (stdinfo.is_noscrubdata     > 0) line_buffer += nformat(1);
								line_buffer.push_back(separator); if (stdinfo.is_integretystream > 0) line_buffer += nformat(1);
								line_buffer.push_back(separator); if (stdinfo.is_pinned          > 0) line_buffer += nformat(1);
								line_buffer.push_back(separator); if (stdinfo.is_unpinned        > 0) line_buffer += nformat(1);
								line_buffer.push_back(separator); if (stdinfo.is_directory       > 0) line_buffer += nformat(1);
								line_buffer.push_back(separator); if (stdinfo.is_compressed      > 0) line_buffer += nformat(1);
								line_buffer.push_back(separator); if (stdinfo.is_encrypted       > 0) line_buffer += nformat(1);
								line_buffer.push_back(separator); if (stdinfo.is_sparsefile      > 0) line_buffer += nformat(1);
								line_buffer.push_back(separator); if (stdinfo.is_reparsepoint    > 0) line_buffer += nformat(1);
								line_buffer.push_back(separator); line_buffer += nformat(stdinfo.attributes());
			...
			_ftprintf(stderr, _T("Finished in %u s\n"), static_cast<unsigned int>((tend - tbegin) / CLOCKS_PER_SEC));
